describe('LastFMDataVis', function () {
    describe('data', function () {
        describe('lastfmservice', function () {
            ...
            beforeEach(inject(function (lastFmService, lastFmApiBaseUrl, $httpBackend, lastFmApiKey) {
            ...
            describe('getTopArtists', function () {
                ...
                it('should return a promise of a list of artists', function () {
                    _lastFmService.getTopArtists().then(function (artists) {
                ...
                it('should limit the number of artists', function () {
                    _lastFmService.getTopArtists(2).then(function (artists) {
                        //artists will vary over time - just need to check they are there and have the right properties
